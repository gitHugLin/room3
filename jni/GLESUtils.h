...
const char gToneMapFragmentShader[] =
        ...
        "precision highp float;\n"
				...
				"newLumi =  4096.0 + (blkLumi*lpLumi)/4096.0;\n"
				"lumiGain = (16384.0*newLumi)/(blkLumi + lpLumi + 410.0);\n"
				...
				"else{blkSizeOffset = blkSizeOffset/512.0;\n"
				"blkIndex = (blkSizeOffset*512.0) + blkCenter;}\n"
				"return blkIndex;}\n"
                "void main() {\n"
                "		vec3 newPixel;\n"
